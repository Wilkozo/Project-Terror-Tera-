...
namespace Gaia.GX.ProceduralWorlds
{
    public class DiggerGaiaIntegration : MonoBehaviour
    {
        ...
        {
            EditorUtility.DisplayDialog("Digger Integration", "Digger is a simple yet powerful tool to create natural caves and overhangs in your Unity terrains directly from the Unity editor. Digger PRO supports runtime editing.", "OK");
        }
