Shader "Digger/LWRP/Terrain/Lit"
{
    Properties
    {
    ...
    SubShader
    {
        Tags { "Queue" = "Geometry-102" "RenderType" = "Opaque" "RenderPipeline" = "LightweightPipeline" "IgnoreProjector" = "False"}
    ...
    Dependency "AddPassShader" = "Digger/LWRP/Terrain/Lit (Add Pass)"
    Dependency "BaseMapShader" = "Digger/LWRP/Terrain/Lit (Base Pass)"
