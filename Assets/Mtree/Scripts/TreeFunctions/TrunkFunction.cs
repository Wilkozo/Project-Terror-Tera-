...
namespace Mtree
{
    public class TrunkFunction : TreeFunctionAsset
    {
        ...
        public override void DrawProperties()
        {
            ...
            EditorGUILayout.PropertyField(obj.FindProperty("rootShape"), new GUIContent("Root shape"));
            Utils.BoundedFloatProperty(obj.FindProperty("rootHeight"), "Height", 0.01f);
            EditorGUILayout.Slider(obj.FindProperty("rootRadius"), 0, 2, new GUIContent("Root Radius"));
            EditorGUILayout.Slider(obj.FindProperty("rootInnerRadius"), 0, 1, new GUIContent("Root Inner Radius"));
            Utils.BoundedFloatProperty(obj.FindProperty("rootResolution"), new GUIContent("Additional Resolution"), 1);
            EditorGUILayout.IntSlider(obj.FindProperty("flareNumber"), 0, 10, new GUIContent("Flare Number"));
