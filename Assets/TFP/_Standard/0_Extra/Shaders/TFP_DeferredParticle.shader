    ...
    SubShader {
        ...
        Pass {
                ...
                out half4 outEmission : SV_Target3 )
            {
                ...
                clip( BinaryDither3x3((_MainTex_var.a*_Alpha*i.vertexColor.a*2.0) - 1.5, sceneUVs) );
////// Lighting:
